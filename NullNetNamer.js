...
//
// 2020-01-04 by MadOverlord, trebor@animeigo.com
//
...
// Do a single pass of relinking. I tried multiple passes but can't figure out
// how to update the json state after each pass. So for now, you just have to
// run the script a few times.

json = api('getSource', {type: "json"});
count += relink(json, json, null);

alert("Relink: " + count + " nets were updated.")
